...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Edit User Type </a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Edit User Type</h1>
			...
			?>
                ...
                <div class="panel-body">
                    <div class="table-info">
                        <?php echo form_open_multipart('Masters/edit_user_type');?>
                      ...
                      <input type="text" id="utype" name="utype" class="form-control" value="<?php echo $user_type_details[0]['user_type'] ?>" /> 
					   <input type="hidden" id="subid" name="subid" class="form-control" value="<?php echo $user_type_details[0]['type_id'] ?>" /> 
