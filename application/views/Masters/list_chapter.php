...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Chapter Master</a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Chapter Master</h1>
            <div class="col-xs-12 col-sm-8">
                <div class="row">                    
                    <hr class="visible-xs no-grid-gutter-h">
                    <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule."/add_chapter")?>"><span class="btn-label icon fa fa-plus"></span>Add Chapter</a></div>                        
        ...
        <div class="row ">
            <div class="col-sm-12">
                ...
                <div class="panel-heading">
                        <span class="panel-title">Chapter List</span>
			...
			?>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="itemContainer">
                            ...
                            {
                            ?>
                            <tr <?=$chapter_list[$i]["status"]=="N"?"style='background-color:#FBEFF2'":""?>>
                                <td><?=$j?></td>
                                <td><?=$chapter_list[$i]['chapter_name']?></td>
                          <td><?=$chapter_list[$i]['subject_name']?></td>
                              <td>
                                    <a href="<?=base_url($currentModule."/edit_chapter/".$chapter_list[$i]['chapter_id'])?>"><i class="fa fa-edit"></i></a>                                                                        
                                    <a href='<?=$chapter_list[$i]["status"]=="Y"?"disable/".$chapter_list[$i]["chapter_id"]:"enable/".$chapter_list[$i]["chapter_id"]?>'><i class='fa <?=$chapter_list[$i]["status"]=="Y"?"fa-ban":"fa-check"?>' title='<?=$chapter_list[$i]["status"]=="Y"?"Disable":"Enable"?>'></i></a>
                                </td>
                            </tr>
                            <?php
                            $j++;
