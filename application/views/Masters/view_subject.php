...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Subjects </h1>
            <div class="col-xs-12 col-sm-8">
                <div class="row">                    
                    <hr class="visible-xs no-grid-gutter-h">
                    <div class="pull-right col-xs-12 col-sm-auto"><a style="width: 100%;" class="btn btn-primary btn-labeled" href="<?=base_url($currentModule."/add_subject")?>"><span class="btn-label icon fa fa-plus"></span>Subjects  </a></div>                        
                ...
                <div class="panel-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody id="itemContainer">
                            ...
                            {
                            ?>
                            <tr <?=$subject_details[$i]["status"]=="N"?"style='background-color:#FBEFF2'":""?>>
                                <td><?=$j?></td>
                                <td><?=$subject_details[$i]['subject_name']?></td>
                          
                              <td>
                                    <a href="<?=base_url($currentModule."/edit_subject/".$subject_details[$i]['subject_id'])?>"><i class="fa fa-edit"></i></a>                                                                        
                    <a href='<?=$subject_details[$i]["status"]=="Y"?"disable/".$subject_details[$i]["subject_id"]:"enable/".$subject_details[$i]["subject_id"]?>'><i class='fa <?=$subject_details[$i]["status"]=="Y"?"fa-ban":"fa-check"?>' title='<?=$subject_details[$i]["status"]=="Y"?"Disable":"Enable"?>'></i></a>
                                </td>
                            </tr>
                            <?php
                            $j++;
