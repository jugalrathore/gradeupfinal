        ...
        <div class="row ">
			...
			?>
                    <div class="table-info">
                        <?php echo form_open_multipart('Masters/edit_chapter');?>
             ...
             <input type="text" id="chapter" name="chapter" class="form-control" value="<?php echo $chapter_details[0]['chapter_name'];?>" /> 
			  <input type="hidden" id="rid" name="rid" value="<?php echo $chapter_details[0]['chapter_id'] ?>" class="form-control" />
               ...
               <select class="form-control" name="subject" id="subject" required="" onchange="">
								<option value="">--Select Subject--</option>
                                    ...
                                    {
                                ?>
     <option value="<?=$subject_list[$i]['subject_id']?>" <?php if($subject_list[$i]['subject_id']==$chapter_details[0]['subject_id']){echo "selected";}  ?>>
	 <?=$subject_list[$i]['subject_name']?></option>
                                <?php
                                    }
                                ?>
																</select>
