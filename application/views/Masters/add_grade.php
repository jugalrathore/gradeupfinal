...
<div id="content-wrapper">
    <ul class="breadcrumb breadcrumb-page">
        ...
        <li class="active"><a href="#">Add Grade </a></li>
    </ul>
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Add Grade</h1>
        ...
        <div class="row ">
			...
			?>
                <div class="panel-heading">
                        <span class="panel-title">Add Grade</span>
                </div>
                <div class="panel-body">
                    <div class="table-info">
                        <?php echo form_open_multipart('Masters/add_grade');?>
                      ...
                      <input type="text" id="grade" name="grade" class="form-control" value="<?=isset($_REQUEST['title'])?$_REQUEST['title']:''?>" /> 
							...
							<tr>
                                ...
                                <td>
                                    <input type="hidden" id="id" name="id" value="" class="form-control" />
                      <input type="text" id="marks" name="marks" class="form-control" value="<?=isset($_REQUEST['title'])?$_REQUEST['title']:''?>" /> 
                                <span style="color:red;"><?php echo form_error('title');?></span>
                                </td>
                            </tr> 
