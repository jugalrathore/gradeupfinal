...
<div id="content-wrapper">
    ...
    <div class="page-header">			
        <div class="row">
            <h1 class="col-xs-12 col-sm-4 text-center text-left-sm"><i class="fa fa-dashboard page-header-icon"></i>&nbsp;&nbsp;Edit Subject</h1>
        ...
        <div class="row ">
			...
			?>
                <div class="panel-heading">
                        <span class="panel-title">Edit Subject</span>
                </div>
                <div class="panel-body">
                    <div class="table-info">
                        <?php echo form_open_multipart('Masters/edit_subject');?>
                      ...
                      <input type="text" id="subject" name="subject" class="form-control" value="<?php echo $subject_details[0]['subject_name'] ?>" /> 
					   <input type="hidden" id="subid" name="subid" class="form-control" value="<?php echo $subject_details[0]['subject_id'] ?>" /> 
